...
public class AdminMainActivity extends AppCompatActivity
    ...
    CardView catg1,catg2,catg3,catg4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catg1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(AdminMainActivity.this, AdminServicesListActivity.class);
                startActivity(i);
            }
        });
        ...
        catg3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*Intent i = new Intent(AdminMainActivity.this, BlogMainActivity.class);
                startActivity(i);*/
                /*Intent i = new Intent(AdminMainActivity.this, UploadActivity.class);
                startActivity(i);*/
                /*Intent i = new Intent(AdminMainActivity.this, WorkActivity.class);
                startActivity(i);*/
                /*Intent i = new Intent(AdminMainActivity.this, PostWorkActivity.class);
                startActivity(i);*/
            }
        });
        ...
        catg4.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AdminMainActivity.this, EmailActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(AdminMainActivity.this, ServicesListActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_salon) {
            Intent i = new Intent(AdminMainActivity.this, SalonActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_work) {

        } else if (id == R.id.nav_map) {
            Intent i = new Intent(AdminMainActivity.this, MapsActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_admin) {
            Intent i = new Intent(AdminMainActivity.this, AdminMainActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(AdminMainActivity.this, ShareExActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(AdminMainActivity.this, ContactActivity.class);
            startActivity(i);
        }
