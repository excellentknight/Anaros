...
public class ContactActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(ContactActivity.this, ServicesListActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_salon) {
            Intent i = new Intent(ContactActivity.this, SalonActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(ContactActivity.this, AdminLoginActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(ContactActivity.this, ShareExActivity.class);
            startActivity(i);
