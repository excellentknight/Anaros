...
public class DevActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn= (Button)findViewById(R.id.visit_website);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DevActivity.this, WebActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(DevActivity.this, ServicesListActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_salon) {
            Intent i = new Intent(DevActivity.this, SalonActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_work) {

        } else if (id == R.id.nav_map) {
            Intent i = new Intent(DevActivity.this, MapsActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_admin) {
            Intent i = new Intent(DevActivity.this, AdminLoginActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(DevActivity.this, ShareExActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(DevActivity.this, ContactActivity.class);
            startActivity(i);
        }
