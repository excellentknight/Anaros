...
public class AdminServicesListActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catg1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(AdminServicesListActivity.this, AdminService1CardActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.admin_services_list, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(AdminServicesListActivity.this, ServicesListActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_salon) {
            Intent i = new Intent(AdminServicesListActivity.this, SalonActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_work) {

        } else if (id == R.id.nav_map) {
            Intent i = new Intent(AdminServicesListActivity.this, MapsActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_admin) {
            Intent i = new Intent(AdminServicesListActivity.this, AdminMainActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_share_ex) {
            Intent i = new Intent(AdminServicesListActivity.this, ShareExActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(AdminServicesListActivity.this, ContactActivity.class);
            startActivity(i);
        }
