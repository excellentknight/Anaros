...
public class AdminLoginActivity extends AppCompatActivity
    ...
    EditText mAdminName,mAdminPass;
    Button mAdminLogin;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdminName=(EditText)findViewById(R.id.admin_name);
        mAdminPass=(EditText)findViewById(R.id.admin_pass);
        ...
        mAdminLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.equals("anaros")&&pass.equals("sorana")){
                    Intent i = new Intent(AdminLoginActivity.this, AdminMainActivity.class);
                    startActivity(i);
                }else {
                    Toast.makeText(AdminLoginActivity.this,"Pls set the right information", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(AdminLoginActivity.this, ServicesListActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_salon) {
            Intent i = new Intent(AdminLoginActivity.this, SalonActivity.class);
            startActivity(i);
        } else if (id == R.id.nav_work) {

        } else if (id == R.id.nav_map) {
            Intent i = new Intent(AdminLoginActivity.this, MapsActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(AdminLoginActivity.this, ShareExActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(AdminLoginActivity.this, ContactActivity.class);
            startActivity(i);
        }
